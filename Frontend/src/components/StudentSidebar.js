                ...
                <div className='stu-sb-container'>
                    ...
                    <div className='stu-sb-menu'>
                        <div className='stu-sb-menu-item'>
                            <NavLink to="/student/dashboard" className={({ isActive }) => (isActive ? "active stu-sb-menu-link" : 'none stu-sb-menu-link')} onClick={handleClick}>
                                <i className='bx bxs-home' style={{ color: '#fef8f8' }}  ></i>
                                <p>Home</p>
                            </NavLink>
                        </div>
                        <div className='stu-sb-menu-item'>
                            <NavLink to="/student/profile" className={({ isActive }) => (isActive ? "active stu-sb-menu-link" : 'none stu-sb-menu-link')} onClick={handleClick}>
                                <i className='bx bxs-user' style={{ color: '#fef8f8' }}></i>
                                <p>Profile</p>
                            </NavLink>
                        </div>
                        <div className='stu-sb-menu-item'>
                            <NavLink to="/student/attendance" className={({ isActive }) => (isActive ? "active stu-sb-menu-link" : 'stu-sb-menu-link none')} onClick={handleClick}>
